...
void main() {
  group('GpsDeduplicator', () {
    ...
    test('accepts position after the dedup window expires', () {
      ...
      dedup.accept(pos);
      final fresh = BuddyPosition(
        userId: 'u1',
        lat: 48.8,
        lng: 2.3,
        updatedAt: base.add(const Duration(seconds: 6)),
      );
    ...
    test('tracks multiple users independently', () {
      final p1 = BuddyPosition(
        userId: 'u1',
        lat: 48.8,
        lng: 2.3,
        updatedAt: base,
      );
      final p2 = BuddyPosition(
        userId: 'u2',
        lat: 48.9,
        lng: 2.4,
        updatedAt: base,
    ...
    test('clear() resets all tracked users', () {
      dedup.accept(
        BuddyPosition(userId: 'u1', lat: 48.8, lng: 2.3, updatedAt: base),
      );
      dedup.clear();
    ...
    test('BudddyPosition equality is based on userId, lat, lng', () {
      final a = BuddyPosition(
        userId: 'u1',
        lat: 48.8,
        lng: 2.3,
        updatedAt: base,
      );
      final b = BuddyPosition(
        userId: 'u1',
        lat: 48.8,
        lng: 2.3,
