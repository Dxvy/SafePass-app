...
class SupabaseOptions {
  ...
  static const String supabaseUrl = 'https://upzenrcwgfbsyvxsocwl.supabase.co';

  /// Your project's anon/public key (safe to use client-side)
  static const String anonKey =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVwemVucmN3Z2Zic3l2eHNvY3dsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzczNzc4MTMsImV4cCI6MjA5Mjk1MzgxM30.YaDEIcxGBnzy0uR4ICXIPz90ilFOqIM85iWwayItQ70';
}
